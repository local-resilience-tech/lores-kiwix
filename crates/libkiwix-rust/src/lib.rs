...
mod ffi {
    ...
    unsafe extern "C++" {
        ...
        /// Return true if the filter has a category set.
        fn filter_has_category(filter: &Filter) -> bool;
        /// Get the filter's category string, if any.
        fn filter_get_category(filter: &Filter) -> String;
